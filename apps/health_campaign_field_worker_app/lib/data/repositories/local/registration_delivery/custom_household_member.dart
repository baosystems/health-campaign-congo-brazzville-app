...
import 'package:registration_delivery/data/repositories/local/household_member.dart';
import 'package:registration_delivery/models/entities/household_member.dart';
import 'package:registration_delivery/utils/extensions/extensions.dart';

class CustomHouseholdMemberLocalRepository
    extends HouseholdMemberLocalRepository {
  CustomHouseholdMemberLocalRepository(
    super.sql,
    super.opLogManager,
  );
      ...
      return results
          .map((e) {
            ...
            return HouseholdMemberModel(
                ...
                additionalFields: householdMember.additionalFields != null
                    ? HouseholdMemberAdditionalFieldsMapper.fromJson(
